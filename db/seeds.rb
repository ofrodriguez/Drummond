...
#=begin
	...
	Equipment.create(reference: 'SH-48')
	Equipment.create(reference: 'San Antonio-Sub')
	Equipment.create(reference: 'Panamericana-Sub')
	Equipment.create(reference: 'Babilla-Sub')
	Equipment.create(reference: 'Martina-Sub')
	Equipment.create(reference: 'Triangle-Sub')
	Equipment.create(reference: 'Ramp-14')
	Equipment.create(reference: 'SUB 110/25kV-#1')
	Equipment.create(reference: 'SUB 110/25kV-#3')
	Equipment.create(reference: 'SUB 110/25kV-#4')
	Equipment.create(reference: 'SUB 110/25kV-#5')
	Equipment.create(reference: 'Tank-1')
	Equipment.create(reference: 'Tank-9/14')
	Equipment.create(reference: 'Tank-11/12')
	Equipment.create(reference: 'Tank-13')
	Equipment.create(reference: 'Tank-5')
