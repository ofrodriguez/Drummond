...
#=begin
	...
	Equipment.create(reference: 'Substation Area')
	...
	Equipment.create(reference: 'Apron Feeder #7')
	Equipment.create(reference: 'Apron Feeder #8')
	Equipment.create(reference: 'Apron Feeder #6')
	Equipment.create(reference: 'Apron Feeder #15')
	Equipment.create(reference: 'Apron Feeder #14')
	Equipment.create(reference: '25kV Circuit')
	Equipment.create(reference: 'PIT')
	#Vehicules
